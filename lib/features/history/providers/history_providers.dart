...
final FutureProviderFamily<List<DoseHistoryData>, DateTime>
doseHistoryForDateProvider =
    FutureProvider.family<List<DoseHistoryData>, DateTime>(
      (ref, date) async {
...
final FutureProviderFamily<Map<String, dynamic>, DateTime>
monthlyAdherenceProvider =
    FutureProvider.family<Map<String, dynamic>, DateTime>(
      (ref, date) async {
        ...
        final takenDoses = monthHistory
            .where((DoseHistoryData d) => d.status == 'taken')
            .length;
        final missedDoses = monthHistory
            .where((DoseHistoryData d) => d.status == 'missed')
            .length;
        final skippedDoses = monthHistory
...
final FutureProviderFamily<Set<DateTime>, DateTime> datesWithDosesProvider =
    FutureProvider.family<Set<DateTime>, DateTime>(
      (ref, date) async {
        final database = ref.watch(appDatabaseProvider);
...
final FutureProviderFamily<List<Map<String, dynamic>>, DateTime>
medicationHistoryProvider =
