...
class BackupSerializer {
  ...
  static MedicationsCompanion medicationFromJson(Map<String, dynamic> json) =>
      MedicationsCompanion.insert(
        ...
        dosePerTime:
            drift.Value((json['dosePerTime'] as num?)?.toDouble() ?? 1.0),
        ...
        remindBeforeRunOut:
            drift.Value(json['remindBeforeRunOut'] as bool? ?? true),
        reminderDaysBeforeRunOut:
            drift.Value(json['reminderDaysBeforeRunOut'] as int? ?? 3),
        ...
        reminderDaysBeforeExpiry:
            drift.Value(json['reminderDaysBeforeExpiry'] as int? ?? 30),
