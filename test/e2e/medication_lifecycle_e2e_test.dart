...
void main() {
  ...
  group('Complete Medication Lifecycle E2E', () {
    test('User Journey: Add medication → Take doses → View analytics → Manage stock', () async {
      ...
      print('✅ Dose history verified: $takenDoses taken, $skippedDoses skipped');
      ...
      print('✅ Stats retrieved: ${stats['taken']} taken, ${stats['skipped']} skipped');
      ...
      print('• Adherence calculated: ${adherencePercentage.toStringAsFixed(1)}%');
    ...
    test('User Journey: Multi-medication management with analytics', () async {
      ...
      for (final med in meds) {
        ...
        print('  • ${med.medicineName}: ${adherence.toStringAsFixed(1)}% adherence ($taken/$total)');
      }
    ...
    test('User Journey: Stock management with expiry tracking', () async {
      ...
      print('✅ Medication added with expiry: ${expiryDate.toString().split(' ')[0]}');
